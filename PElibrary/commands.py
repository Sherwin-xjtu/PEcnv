...
from . import (access, antitarget, autobin, batch, bintest, call, core,
               coverage, diagram, export, fix, heatmap, importers,
...
def _cmd_import_picard(args):
    """Convert Picard CalculateHsMetrics tabular output to PEcnv .cnn files.
...
def _cmd_import_seg(args):
    """Convert a SEG file to PEcnv .cns files."""
...
def _cmd_import_theta(args):
    ...
    Equivalently, use the THetA results file to convert PEcnv .cns segments to
...
P_export_theta.add_argument('tumor_segment',
        help="""Tumor-sample segmentation file from PEcnv (.cns).""")
