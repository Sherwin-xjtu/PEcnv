...
from pegeno.gary import GenomicArray as GA
from pegeno.tabio import (bedio, genepred, gff, picard, seg, seqdict, tab, textcoord, vcfio,
                          vcfsimple)


def read(infile, fmt="tab", into=None, sample_id=None, meta=None, **kwargs):

    from PElibrary.kernel import fbase
    if fmt == 'auto':
