...
def convolve_weighted(window, signal, weights, n_iter=1):
    ...
    for _i in range(n_iter):
        ...
        y = D / N
        # Update weights to account for the adjusting
...
def rolling_outlier_quantile(x, width, q, m):
    ...
    This is the adjusting method used in BIC-seq (doi:10.1073/pnas.1110574108)
