...
from skgenome.gary import GenomicArray as GA
from skgenome.tabio import (bedio, genepred, gff, picard, seg, seqdict, tab, textcoord, vcfio,
               vcfsimple)


def read(infile, fmt="tab", into=None, sample_id=None, meta=None, **kwargs):

    from PElibrary.core import fbase
    if fmt == 'auto':
    ...
    try:
        ...
        dframe = []
    if fmt == "vcf":
        from PElibrary.vary import VariantArray as VA
        suggest_into = VA
